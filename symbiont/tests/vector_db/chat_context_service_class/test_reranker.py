import pytest
from symbiont.vector_dbs.vector_service import ChatContextService, Citation
...
def test_rerank_context(chat_context_service):
    ...
    with patch("symbiont.vector_dbs.vector_service.co.rerank", return_value=mock_rerank_result):
